# Autogenerated wrapper script for GeographicLib_jll for x86_64-apple-darwin
...
JLLWrappers.@declare_library_product(libGeographic, "@rpath/libGeographic.19.dylib")
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libGeographic,
        "lib/libGeographic.19.2.0.dylib",
